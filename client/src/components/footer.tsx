...
function FooterLink({ href, label }: FooterLinkProps) {
  return (
    <li>
      <a href={href} className="text-gray-400 hover:text-primary transition duration-200">
        {label}
      </a>
    </li>
  );
...
export default function Footer() {
  return (
    <footer className="py-12 bg-[#111111] px-4 md:px-0">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-12">
          ...
          >
            ...
            <p className="text-gray-400">
              Innovative solutions for business growth and lead generation.
            </p>
          </motion.div>
